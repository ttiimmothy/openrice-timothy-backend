...
let PaymentMethodController = class PaymentMethodController {
    ...
    async getPaymentMethodByID(params) {
        return (await this.paymentMethodService.getPaymentMethodByID(params.payment_method_id))[0];
    }
};
...
exports.PaymentMethodController = PaymentMethodController = __decorate([
    ...
    (0, common_1.Controller)('api/payment-method'),
